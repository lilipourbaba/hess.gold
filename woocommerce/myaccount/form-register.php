...
<?php if ('yes' === get_option('woocommerce_enable_myaccount_registration')): ?>
	<div class="u-columns col2-set" id="customer_login">
		...
		<main>
			<p>
			<h2> <i class="iconsax close-pop" icon-name="x"></i>
				<?= "ورود به گالری حس" ?></h2>
			</p>
			<div class="full-width contact-hero jc-center  d-flex ai-center | login-hero">
				<div class="container bg-natural-100  jc-center ai-center">
					<form class="woocommerce-form woocommerce-form-login login" method="post">
						<?php do_action('woocommerce_login_form_start'); ?>
						<p class="text-right text-primary ">
							<i class="iconsax" icon-name="phone"></i>
							<input pattern="[0]{1}[9]{1}[0-9]{2}[0-9]{3}[0-9]{4}" class=" data" type="tel"
								name="user_tel" placeholder="شماره موبایل" required>
						</p>
						<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
							<input type="text" class="woocommerce-Input woocommerce-Input--text input-text data"
