...
<form class="variations_form cart"
	...
	<?php else: ?>
		<table class="variations w-100" cellspacing="0" role="presentation">
			<tbody>
				<?php foreach ($attributes as $attribute_name => $options): ?>
					...
					<tr>
						<td class="value w-100 d-flex ai-center">
							...
							?>
							<i class="iconsax pos-relative" icon-name="chevron-down"></i>
		...
		<div class="mb-24"><?php wc_get_template('single-product/price.php'); ?></div>
